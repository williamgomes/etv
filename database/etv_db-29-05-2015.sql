...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2015 at 01:17 AM
...
(2, NULL, NULL, 'GABBAR', NULL, 'This is sample summary', NULL, 'http://annawrites.com/blog/wp-content/uploads/2012/02/family-guy.jpg', 'http://annawrites.com/blog/wp-content/uploads/2012/02/family-guy.jpg', 'Daryl Dixon', 'Daryl Dixon', 'Daryl Dixon', 'Daryl Dixon', 'This is sample bio', NULL, 'active', NULL, '2015-05-11 22:54:13', NULL, '2015-05-11 17:16:10', NULL),
...
CREATE TABLE IF NOT EXISTS `character_season_episode` (
  ...
  PRIMARY KEY (`CSE_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='CSE = Character Season Episode' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `character_show` (
  ...
  PRIMARY KEY (`CS_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='CS = Character Show' AUTO_INCREMENT=88 ;
...
(1, 53, 1, '', 'This is spoiler no 1.', '2015-05-28 20:45:19', 1, '2015-05-28 14:45:19', 1, 'active'),
...
(4, 53, 1, '', 'this is spoiler 1', '2015-05-28 22:44:15', 1, '2015-05-28 16:44:15', 1, 'active');

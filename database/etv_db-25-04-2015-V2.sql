...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2015 at 10:11 PM
...
CREATE TABLE IF NOT EXISTS `quotes` (
  ...
  `quote_text` text CHARACTER SET utf8,
  ...
  `quote_status` enum('active','inactive') CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `quote_feedbacks` (
  ...
  `quote_feedback_feedback` enum('approve','dispute') CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `spoiler_feedbacks` (
  ...
  `spoiler_feedback_feedback` enum('approve','dispute') CHARACTER SET utf8 NOT NULL,

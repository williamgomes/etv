...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2015 at 03:46 PM
...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  `post_original_creator` text NOT NULL,
...
INSERT INTO `posts` (`post_id`, `post_title`, `post_cover_image`, `post_content`, `post_about`, `post_type`, `post_show_ids`, `post_episode_ids`, `post_character_ids`, `post_tags`, `post_primary_type`, `post_secondary_type`, `post_popularity`, `post_original_creator`, `post_status`, `post_created_on`, `post_created_by`, `post_updated_on`, `post_updated_by`) VALUES
...
(6, 'SH013898090000', 8553063, 5, 50, 'Fantasy,Drama', 'Noble families in the seven kingdoms of Westeros vie for control of the Iron Throne.', 'Game of Thrones', 'George R.R. Martin''s best-selling book series "A Song of Ice and Fire" is brought to the screen as HBO sinks its considerable storytelling teeth into the medieval fantasy epic. It''s the depiction of two powerful families -- kings and queens, knights and renegades, liars and honest men -- playing a deadly game for control of the Seven Kingdoms of Westeros, and to sit atop the Iron Throne. Martin is credited as a co-executive producer and one of the writers for the series, which was filmed in Northern Ireland and Malta.', 'George R.R. Martin''s best-selling book series "A Song of Ice and Fire" is brought to the screen as HBO sinks its considerable storytelling teeth into the medieval fantasy epic. It''s the depiction of two powerful families -- kings and queens, knights and renegades, liars and honest men -- playing a deadly game for control of the Seven Kingdoms of Westeros, and to sit atop the Iron Throne. Martin is credited as a co-executive producer and one of the writers for the series, which was filmed in Northern Ireland and Malta.', '["images\\/uploads\\/shows\\/91zikkqy7ol-_sl1500_-arrow-the-complete-second-season-blu-ray-review-jpeg-142123.jpg"]', 'assets/p8553063_b_v5_ad.jpg', '"\\/images\\/uploads\\/shows\\/91zikkqy7ol-_sl1500_-arrow-the-complete-second-season-blu-ray-review-jpeg-142123.jpg"', 'ERTs', 'Game Of Thrones', 'active', 'active', 'active', '30.00', '2015-04-27 18:14:54', 0, '2015-05-12 17:42:32', 0),
...
INSERT INTO `users` (`user_id`, `user_email`, `user_password`, `google_user_id`, `user_hash`, `user_status`, `user_verification`, `user_first_name`, `user_middle_name`, `user_last_name`, `user_image`, `user_DOB`, `user_gender`, `user_aboutme`, `user_street_address`, `user_country`, `user_city`, `user_zip`, `user_phone`, `user_last_login`) VALUES

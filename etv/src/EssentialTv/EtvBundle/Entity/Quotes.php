...
class Quotes
{
     ...
     * @var integer
     */
    private $quoteCharacterId;

    /**
     * @var integer
     */
    private $quoteEpisodeId;


    /**
     * Set quoteUserId
     *
     * @param integer $quoteUserId
     * @return Quotes
     */
    public function setQuoteUserId($quoteUserId)
    {
     ...
     * @return integer 
     */
    public function getQuoteUserId()
    {
        return $this->quoteUserId;
    }

    /**
     * Set quoteCharacterId
     *
     * @param integer $quoteCharacterId
     * @return Quotes
     */
    public function setQuoteCharacterId($quoteCharacterId)
    {
        $this->quoteCharacterId = $quoteCharacterId;

        return $this;
    }

    /**
     * Get quoteCharacterId
     *
     * @return integer 
     */
    public function getQuoteCharacterId()
    {
        return $this->quoteCharacterId;
    }

    /**
     * Set quoteEpisodeId
     *
     * @param integer $quoteEpisodeId
     * @return Quotes
     */
    public function setQuoteEpisodeId($quoteEpisodeId)
    {
        $this->quoteEpisodeId = $quoteEpisodeId;

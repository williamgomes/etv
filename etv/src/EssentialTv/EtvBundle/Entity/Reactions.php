...
/**
 * @ORM\Entity(repositoryClass="EssentialTv\EtvBundle\Entity\ReactionRepository")
 */
...
class Reactions {
    ...
    /**
     * Set reactionEpisodeId
     *
     * @param integer $reactionEpisodeId
     * @return Reactions
     */
    public function setReactionEpisodeId($reactionEpisodeId)
    {
        $this->reactionEpisodeId = $reactionEpisodeId;

        return $this;
    }

    /**
     * Get reactionEpisodeId
     *
     * @return integer 
     */
    public function getReactionEpisodeId()
    {
        return $this->reactionEpisodeId;
    }
